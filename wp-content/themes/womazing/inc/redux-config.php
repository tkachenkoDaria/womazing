...
$args = array(
	...
	'menu_title'                => esc_html__( 'Изменить контент', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Изменить контент', 'your-textdomain-here' ),
...
$args['footer_text'] = '<p>' . esc_html__( 'Это Ваша панель управления сайтом. Создайте свой уникальный контент!', 'your-textdomain-here' ) . '</p>';
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'home',
		'desc'             => esc_html__( 'Редактурийте главную страницу', 'your-textdomain-here' ),
...
require_once get_template_directory() . "/inc/redux-components/home/advantages.php";

require_once get_template_directory() . "/inc/redux-components/home/commands.php";
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'footer',
		'desc'             => esc_html__( 'Редактурийте подвал сразу на всех страницу', 'your-textdomain-here' ),
		'customizer_width' => '400px',
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'about',
		'desc'             => esc_html__( 'Редактурийте страницу О нас', 'your-textdomain-here' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-idea',
	)
);

require_once get_template_directory() . "/inc/redux-components/about/section.php";
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'contacts',
		'desc'             => esc_html__( 'Редактурийте страницу контакты', 'your-textdomain-here' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-address-book',
	)
);

require_once get_template_directory() . "/inc/redux-components/contacts/map.php";
