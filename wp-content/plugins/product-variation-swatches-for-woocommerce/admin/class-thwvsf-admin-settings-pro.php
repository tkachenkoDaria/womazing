			...
			<div class="th-nice-box">
			    ...
			    <ul class="feature-list star-list">
			        <li>
			        	...
			        	<div class = "th-feat-desc">The Premium version provides you with a total of 4 Swatch Types, 
			         ...
			         <li>
			        	...
			        	<div class = "th-feat-desc">Display variation swatches on WooCommerce Shop Page to view the availability of products</div>
			        </li>
			         <li>
			         ...
			         <li>
			        	<div class = "th-feat-head">Default swatches to variation Image or Label swatches</div>
			        	<div class = "th-feat-desc">Default dropdown swatch style can be auto converted to Label or Variation Image swatches. </div>
			        </li>
			         <li>
