...
class THWVSF {
	...
	private function define_admin_hooks() {
		...
		add_action( 'wp_ajax_dismiss_thwvsf_review_request_notice', array($plugin_admin, 'dismiss_thwvsf_review_request_notice'));
		add_action( 'wp_ajax_skip_thwvsf_review_request_notice', array($plugin_admin, 'skip_thwvsf_review_request_notice'));
	}
